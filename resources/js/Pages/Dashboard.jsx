                        ...
                        <div id="kt_app_content_container" class="app-container  container-fluid ">
                            ...
                            <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                                    ...
                                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style={{"background-color": "#F1416C",backgroundImage:"url('assets/media/patterns/vector-1.png')"}}>
                                        {/* <!--begin::Header--> */}
                                    ...
                                    <div class="card card-flush h-lg-50">  
                                        ...
                                        <div class="card-header pt-5">
                                            ...
                                            <div class="card-toolbar">            
                                                ...
                                                </button><div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                                        {/* <!--begin::Menu item--> */}
                                ...
                                <div class="col-xxl-6">
                                    ...
                                    <div class="card card-flush h-md-100"> 
                                        {/* <!--begin::Body--> */}
                                        <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style={{backgroundPosition: "100% 50%", backgroundImage:"url('assets/media/stock/900x600/42.png')"}}>     
                                            {/* <!--begin::Wrapper--> */} 
                                            <div class="mb-10">
                                                {/* <!--begin::Title--> */}      
                                        ...
                                        <div class="card-body pt-6">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade" id="kt_chart_widget_8_week_tab" role="tabpanel" aria-labelledby="#kt_chart_widget_8_week_toggle">                
                                                    ...
                                                    {/* <!--begin::Chart--> */}
                                                    <div id="kt_chart_widget_8_week_chart" class="ms-n5 min-h-auto" style={{"height": 275}}></div>     
                                                    {/* <!--end::Chart--> */} 
                                        ...
                                        <div class="card-body py-9">  
                                            ...
                                            <div class="row gx-9 h-100">
                                                ...
                                                <div class="col-sm-6 mb-10 mb-sm-0">
                                                    {/* <!--begin::Image--> */}
                                                    <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" style={{"background-size": "100% 100%", backgroundImage:"url('assets/media/stock/600x600/img-65.jpg')"}}>              
                                                    </div> 
                                                    {/* <!--end::Image--> */}
                                                </div>
                                                {/* <!--end::Col--> */}  
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-toolbar">   
                                        ...
                                        <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left" data-kt-daterangepicker-range="today" class="btn btn-sm btn-light d-flex align-items-center px-4" data-kt-initialized="1">           
                                            {/* <!--begin::Display range--> */}
                                            <div class="text-gray-600 fw-bold">18 Jun 2024</div>
                                            {/* <!--end::Display range--> */}
                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card-body d-flex align-items-end pt-0">         
                                    {/* <!--begin::Chart--> */}
                                    {/* <div id="kt_charts_widget_31_chart" class="w-100 h-300px"><div style={{position: "relative", height: "100%"}}><div style="position: absolute; width: 426px; height: 300px;">
                                    <div><canvas width="426" height="300" style="position: absolute; top: 0px; left: 0px; width: 426px; height: 300px;"></canvas>
                                    <canvas width="426" height="300" style="position: absolute; top: 0px; left: 0px; width: 426px; height: 300px;"></canvas>
                                    </div></div><div class="am5-html-container" style="position: absolute; pointer-events: none; overflow: hidden; width: 426px; height: 300px;"></div><div class="am5-reader-container" role="alert" style="position: absolute; width: 1px; height: 1px; overflow: hidden; clip: rect(1px, 1px, 1px, 1px);"></div><div class="am5-focus-container" role="application" style="position: absolute; pointer-events: none; top: 0px; left: 0px; overflow: hidden; width: 426px; height: 300px;"><div role="button" aria-label="Zoom Out" style="position: absolute; pointer-events: none; top: 8px; left: -48px; width: 4px; height: 4px;" tabindex="0"></div><div tabindex="0" role="checkbox" aria-label="Revenue; Press ENTER to toggle" aria-checked="true" style="position: absolute; pointer-events: none; top: -2px; left: -2px; width: 4px; height: 4px;"></div><div tabindex="0" role="checkbox" aria-label="Expense; Press ENTER to toggle" aria-checked="true" style="position: absolute; pointer-events: none; top: -2px; left: -2px; width: 4px; height: 4px;"></div></div><div class="am5-tooltip-container"><div role="tooltip" style="position: absolute; width: 1px; height: 1px; overflow: hidden; clip: rect(1px, 1px, 1px, 1px); pointer-events: none;">Revenue: 42.9
                            Expense:11.9</div></div></div></div>        */}
                                    {/* <!--end::Chart--> */}            
                                </div>
                                {/* <!--end::Body--> */}
                            </div>
                            ...
                            {/* <!--end::Menu 2--> */}
                                ...
                                <div class="card-body pt-0">  
                                    {/* <!--begin::Chart--> */}
                                    {/* <div id="kt_charts_widget_24" class="min-h-auto" style="height: 300px"><div style="position: relative; height: 100%;"><div style="position: absolute; width: 943px; height: 300px;"><div><canvas width="943" height="300" style="position: absolute; top: 0px; left: 0px; width: 943px; height: 300px;"></canvas><canvas width="943" height="300" style="position: absolute; top: 0px; left: 0px; width: 943px; height: 300px;"></canvas></div></div><div class="am5-html-container" style="position: absolute; pointer-events: none; overflow: hidden; width: 943px; height: 300px;"></div><div class="am5-reader-container" role="alert" style="position: absolute; width: 1px; height: 1px; overflow: hidden; clip: rect(1px, 1px, 1px, 1px);"></div><div class="am5-focus-container" role="application" style="position: absolute; pointer-events: none; top: 0px; left: 0px; overflow: hidden; width: 943px; height: 300px;"><div role="button" aria-label="Zoom Out" style="position: absolute; pointer-events: none; top: 24px; left: 574.596px; width: 40px; height: 40px;"></div></div><div class="am5-tooltip-container"><div role="tooltip" style="position: absolute; width: 1px; height: 1px; overflow: hidden; clip: rect(1px, 1px, 1px, 1px); pointer-events: none;">California</div></div></div></div> */}
                                    {/* <!--end::Chart--> */} 
                                </div>
                                {/* <!--end::Card body--> */}
                            </div>
